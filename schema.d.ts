...
export interface components {
    schemas: {
        ...
        BlockHeaderView: {
            ...
            block_body_hash?: components["schemas"]["CryptoHash"];
            block_merkle_root: components["schemas"]["CryptoHash"];
            /** Format: uint64 */
            ...
            epoch_id: components["schemas"]["CryptoHash"];
            epoch_sync_data_hash?: components["schemas"]["CryptoHash"];
            gas_price: string;
        ...
        CauseRpcErrorKind: components["schemas"]["RpcRequestValidationErrorKind"] | unknown | unknown;
        ...
        ChunkHeaderView: {
            ...
            bandwidth_requests?: components["schemas"]["BandwidthRequests"];
            chunk_hash: components["schemas"]["CryptoHash"];
            congestion_info?: components["schemas"]["CongestionInfoView"];
            /** Format: uint64 */
        ...
        CreateAccountAction: Record<string, never>;
        CryptoHash: string;
        ...
        DumpConfig: {
            ...
            iteration_delay?: components["schemas"]["DurationSchemeProvider"];
        ...
        EpochSyncConfig: {
            ...
            timeout_for_epoch_sync: components["schemas"]["DurationSchemeProvider"];
        };
        ...
        GCConfig: {
             ...
             *     }
             */
            gc_step_period: components["schemas"]["DurationSchemeProvider"];
        };
        GenesisConfig: {
            ...
            gas_price_adjustment_rate: components["schemas"]["Rational32SchemaProvider"];
            /**
             * Format: uint64
            ...
            max_inflation_rate: components["schemas"]["Rational32SchemaProvider"];
            /**
             * Format: uint8
             ...
             *     }
             */
            minimum_stake_ratio: components["schemas"]["Rational32SchemaProvider"];
            /**
             * Format: uint64
             ...
             *     }
             */
            online_max_threshold: components["schemas"]["Rational32SchemaProvider"];
            /**
             ...
             *     }
             */
            online_min_threshold: components["schemas"]["Rational32SchemaProvider"];
            /** @description Protocol treasury rate */
            protocol_reward_rate: components["schemas"]["Rational32SchemaProvider"];
             ...
             *     }
             */
            protocol_upgrade_stake_threshold: components["schemas"]["Rational32SchemaProvider"];
            /**
             * Format: uint32
        ...
        GenesisConfigRequest: Record<string, never>;
        GlobalContractData: {
            code: string;
        ...
        /** JsonRpcResponse_for_Array_of_MaintenanceWindow_and_RpcError */
        JsonRpcResponse_for_Array_of_MaintenanceWindow_and_RpcError: {
            id: string;
            jsonrpc: string;
        } | {
            result: components["schemas"]["MaintenanceWindow"][];
        } | {
            tmp: components["schemas"]["RpcError"];
        } | {
        ...
        LimitConfig: {
            ...
            /**
             * Format: uint8
             * @description Whether a legacy version of stack limiting should be used, see
        ...
        /** @enum {string} */
        NameRpcErrorKind: "REQUEST_VALIDATION_ERROR" | "HANDLER_ERROR" | "INTERNAL_ERROR";
        NetworkInfoView: {
        ...
        ReceiptEnumView: {
            ...
            GlobalContractDistribution: {
                data: components["schemas"]["GlobalContractData"];
            };
        };
        ...
        RpcClientConfigRequest: Record<string, never>;
        ...
        RpcClientConfigResponse: {
            ...
            chunk_distribution_network?: components["schemas"]["ChunkDistributionNetworkConfig"];
            ...
            tracked_accounts: components["schemas"]["AccountId"][];
            /** @description Track shards that should be tracked by given validator. */
            tracked_shadow_validator?: components["schemas"]["AccountId"];
            ...
            tracked_shard_schedule: components["schemas"]["ShardId"][][];
        ...
        RpcError: {
            cause?: components["schemas"]["CauseRpcErrorKind"];
            /** Format: int64 */
            code: number;
            data?: unknown;
            message: string;
            name?: components["schemas"]["NameRpcErrorKind"];
        };
        /** RpcGasPriceRequest */
        RpcGasPriceRequest: {
        ...
        /** RpcHealthRequest */
        RpcHealthRequest: Record<string, never>;
        RpcHealthResponse: Record<string, never>;
        RpcKnownProducer: {
            account_id: components["schemas"]["AccountId"];
            addr?: string | null;
        ...
        RpcLightClientExecutionProofRequest: {
            light_client_head: components["schemas"]["CryptoHash"];
            type: components["schemas"]["TypeTransactionOrReceiptId"];
        } | {
            sender_id: components["schemas"]["AccountId"];
        ...
        RpcNetworkInfoRequest: Record<string, never>;
        ...
        RpcProtocolConfigResponse: {
            ...
            /**
             * Format: uint64
             * @description Number of validator seats for chunk only producers.
             */
            num_chunk_only_producer_seats: number;
            /** @description Online maximum threshold above which validator gets full reward. */
            online_max_threshold: components["schemas"]["Rational32SchemaProvider"];
        ...
        RpcSplitStorageInfoRequest: Record<string, never>;
        ...
        RpcStatusResponse: {
            ...
            node_key?: components["schemas"]["PublicKey"];
            ...
            validator_account_id?: components["schemas"]["AccountId"];
            /** @description Public key of the validator. */
            validator_public_key?: components["schemas"]["PublicKey"];
        ...
        RuntimeFeesConfigView: {
            ...
            burnt_gas_reward: components["schemas"]["Rational32SchemaProvider"];
            ...
            pessimistic_gas_price_inflation_ratio: components["schemas"]["Rational32SchemaProvider"];
        ...
        StateChangeValueViewContent: {
            ...
            amount: string;
            code_hash: components["schemas"]["CryptoHash"];
            global_contract_account_id?: components["schemas"]["AccountId"];
            global_contract_hash?: components["schemas"]["CryptoHash"];
            locked: string;
            /**
             * Format: uint64
             * @description TODO(2271): deprecated.
        ...
        /** @enum {string} */
        StateChangeValueViewType: "account_update" | "account_deletion" | "access_key_update" | "data_update" | "data_deletion" | "contract_code_update" | "contract_code_deletion";
        StateChangeWithCauseView: {
            cause: components["schemas"]["StateChangeCauseView"];
            change: components["schemas"]["StateChangeValueViewContent"];
            type: components["schemas"]["StateChangeValueViewType"];
        };
        /** @description Options for dumping state to S3. */
        StateSyncConfig: {
            /** @description `none` value disables state dump to external storage. */
            dump?: components["schemas"]["DumpConfig"];
            sync?: components["schemas"]["SyncConfig"];
        };
        StatusSyncInfo: {
            earliest_block_hash?: components["schemas"]["CryptoHash"];
            /** Format: uint64 */
        ...
        /** @enum {string} */
        TypeTransactionOrReceiptId: "transaction" | "receipt";
        /** @description Use global contract action */
        UseGlobalContractAction: {
            contract_identifier: components["schemas"]["GlobalContractIdentifier"];
        };
        VMConfigView: {
            /** @description See [VMConfig::alt_bn128](crate::vm::Config::alt_bn128). */
            alt_bn128: boolean;
            /** @description See [VMConfig::disable_9393_fix](crate::vm::Config::disable_9393_fix). */
            ...
            /** @description See [VMConfig::ed25519_verify](crate::vm::Config::ed25519_verify). */
            ...
            /** @description See [VMConfig::function_call_weight](crate::vm::Config::function_call_weight). */
            ...
            /** @description See [VMConfig::math_extension](crate::vm::Config::math_extension). */
            ...
            /** @description See [VMConfig::yield_resume_host_functions](`crate::vm::Config::yield_resume_host_functions). */
            yield_resume_host_functions: boolean;
        };
        VMKind: "Wasmer0" | "Wasmtime" | "Wasmer2" | "NearVm";
        ValidatorInfo: {
            account_id: components["schemas"]["AccountId"];
            is_slashed: boolean;
        };
        /** @description Reasons for removing a validator from the validator set. */
        ValidatorKickoutReason: "Slashed" | {
            NotEnoughBlocks: {
                /** Format: uint64 */
                expected: number;
                /** Format: uint64 */
        ...
        ValidatorStakeView: components["schemas"]["ValidatorStakeViewV1"];
    ...
    EXPERIMENTAL_maintenance_windows: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["JsonRpcResponse_for_Array_of_MaintenanceWindow_and_RpcError"];
                };
            };
        };
    };
