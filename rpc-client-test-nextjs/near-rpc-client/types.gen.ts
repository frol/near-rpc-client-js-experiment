...
export type RpcClientConfigResponse = {
   ...
   */
  view_client_throttle_period: [number, number];
};
...
export type ExperimentalChangesResponse =
  ExperimentalChangesResponses[keyof ExperimentalChangesResponses];
...
export type ExperimentalReceiptResponse =
  ExperimentalReceiptResponses[keyof ExperimentalReceiptResponses];
...
export type ExperimentalTxStatusResponse =
  ExperimentalTxStatusResponses[keyof ExperimentalTxStatusResponses];
...
export type BroadcastTxAsyncResponse =
  BroadcastTxAsyncResponses[keyof BroadcastTxAsyncResponses];
...
export type BroadcastTxCommitResponse =
  BroadcastTxCommitResponses[keyof BroadcastTxCommitResponses];
...
export type ClientConfigResponse =
  ClientConfigResponses[keyof ClientConfigResponses];
...
export type LightClientProofResponse =
  LightClientProofResponses[keyof LightClientProofResponses];
...
export type NetworkInfoResponse =
  NetworkInfoResponses[keyof NetworkInfoResponses];
...
export type NextLightClientBlockResponse =
  NextLightClientBlockResponses[keyof NextLightClientBlockResponses];
